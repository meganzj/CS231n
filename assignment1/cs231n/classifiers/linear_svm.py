...
def svm_loss_vectorized(W, X, y, reg):
  ...
  # result in loss.                                                           #
  #############################################################################
  scores = X.dot(W) # shape of (N,C)
  correct_class_score = scores[(range(X.shape[0]), y)] #to acces the correct
                                                      #for each row
  margin = scores - correct_class_score + 1 #calculate margin
  margin[(range(X_train.shape[0]), y_train)] = 0 #set correct class margin = 0
